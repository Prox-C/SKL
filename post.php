          ...
          <div class="col-md-6">
            <div class="card rounded-3">
              ...
              <input type="hidden" name="lname" value="<?php echo htmlspecialchars($lname); ?>">
                    ...
                    <div class="form-group">
                        <textarea name="comment" class="form-control" id="userComments" rows="4" placeholder="What's on your mind?" maxlength="200" required></textarea>
                    </div>
                    <button name="submit-comment" type="submit" class="btn bg-indigo float-right rounded-3" style="padding: 8px 16px; display: flex; align-items: center; gap: 4px;">
                        Comment
                        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="14" fill="#FFFFFF" style="margin-left: 4px">
