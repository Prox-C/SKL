<?php
  ...
  if (isset($_POST['create'])) {
    $category_name = ucwords((string) $_POST['category_name']);
    $result = add_category($category_name);

    if ($result === "category_exists") {
        echo "<script>alert('This category already exists.'); location.href='categories.php';</script>";
    } else {
  ...
  if(isset($_POST['save'])) 
  {
    ...
    $category_name = ucwords((string)$_POST['xcategory_name']);
              ...
              <form action="categories.php" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input style="text-transform: capitalize" name="category_name" type="text" class="form-control" id="name" placeholder="Example: Tech, Politics, Lifestyle, etc." required>
                  </div>
                </div>
        ...
        <div class="card">
              ...
              <form action="categories.php" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="category">Category Name</label>
                    <input style="text-transform: capitalize" name="xcategory_name" type="text" class="form-control" id="name" placeholder="Example: Tech, Politics, Lifestyle, etc." value="<?php echo $record['category_name'];?>">
                  </div>
                </div>
                <div class="card-footer">
