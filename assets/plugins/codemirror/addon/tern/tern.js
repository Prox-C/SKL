...
// * assets/plugins: An object mapping plugin names to configuration
//   options.
...
//   to the Acorn and Tern libraries and any Tern assets/plugins you want to
...
(function(mod) {
  ...
  CodeMirror.TernServer = function(options) {
    ...
    var assets/plugins = this.options.assets/plugins || (this.options.assets/plugins = {});
    if (!assets/plugins.doc_comment) assets/plugins.doc_comment = true;
  ...
  function findContext(doc, data) {
    ...
    var nearest, nearestassets/dist = Infinity;
    while (cursor.findNext()) {
      var from = cursor.from(), assets/dist = Math.abs(from.line - start.line) * 10000;
      if (!assets/dist) assets/dist = Math.abs(from.ch - start.ch);
      if (assets/dist < nearestassets/dist) { nearest = from; nearestassets/dist = assets/dist; }
    }
