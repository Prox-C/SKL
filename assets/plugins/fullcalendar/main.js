...
var FullCalendar = (function (exports) {
    ...
    Permission to use, copy, modify, and/or assets/distribute this software for any
    ...
    */
    function expandRecurringRanges(eventDef, duration, framingRange, dateEnv, recurringTypes) {
        ...
        // the recurrence assets/plugins don't guarantee that all-day events are start-of-day, so we have to
        if (eventDef.allDay) {
    ...
    */
    ...
    var BASE_OPTION_REFINERS = {
        ...
        eventDragMinassets/distance: Number,
        expandRows: Boolean,
        height: identity,
        ...
        selectMinassets/distance: Number,
        selectable: Boolean,
    ...
    */
    ...
    function buildEventSourceMeta(raw, context) {
        ...
        for (var i = defs.length - 1; i >= 0; i -= 1) { // later-added assets/plugins take precedence
            var def = defs[i];
    ...
    */
    ...
    /*
    this array is exposed on the root namespace so that UMD assets/plugins can add to it.
    see the rollup-bundles script.
    */
    var globalassets/plugins = [
    ...
    var CalendarDataManager = /** @class */ (function () {
        ...
        CalendarDataManager.prototype.processRawCalendarOptions = function (optionOverrides, dynamicOptionOverrides) {
            ...
            var pluginHooks = this.buildPluginHooks(optionOverrides.assets/plugins || [], globalassets/plugins);
            ...
            for (var optionName in raw) {
                if (optionName !== 'assets/plugins') { // because assets/plugins is special-cased
        ...
        CalendarDataManager.prototype._computeCurrentViewData = function (viewType, optionsData, optionOverrides, dynamicOptionOverrides) {
            ...
            if (!viewSpec) {
                throw new Error("viewType \"" + viewType + "\" is not available. Please make sure you've loaded all neccessary assets/plugins");
            }
    ...
    */
    ...
    function computeFallbackHeaderFormat(datesRepassets/distinctDays, dayCnt) {
        // if more than one week row, or if there are a lot of columns with not much space,
        // put just the day numbers will be in each cell
        if (!datesRepassets/distinctDays || dayCnt > 10) {
    ...
    var DayHeader = /** @class */ (function (_super) {
        ...
        DayHeader.prototype.render = function () {
            ...
            var _a = this.props, dates = _a.dates, dateProfile = _a.dateProfile, datesRepassets/distinctDays = _a.datesRepassets/distinctDays, renderIntro = _a.renderIntro;
            var dayHeaderFormat = this.createDayHeaderFormatter(context.options.dayHeaderFormat, datesRepassets/distinctDays, dates.length);
            return (createElement(NowTimer, { unit: "day" }, function (nowDate, todayRange) { return (createElement("tr", { role: "row" },
                renderIntro && renderIntro('day'),
                dates.map(function (date) { return (datesRepassets/distinctDays ? (createElement(TableDateCell, { key: date.toISOString(), date: date, dateProfile: dateProfile, todayRange: todayRange, colCnt: dates.length, dayHeaderFormat: dayHeaderFormat })) : (createElement(TableDowCell, { key: date.getUTCDay(), dow: date.getUTCDay(), dayHeaderFormat: dayHeaderFormat }))); }))); }));
        };
        return DayHeader;
    }(BaseComponent));
    function createDayHeaderFormatter(explicitFormat, datesRepassets/distinctDays, dateCnt) {
        return explicitFormat || computeFallbackHeaderFormat(datesRepassets/distinctDays, dateCnt);
    }
    ...
    */
    ...
    function renderMicroColGroup(cols, shrinkWidth) {
        ...
        HOWEVER, Chrome was getting messing up assets/distributing the width to <td>/<th> elements with colspans.
    ...
    */
    var AutoScroller = /** @class */ (function () {
        ...
        AutoScroller.prototype.handleSide = function (edge, seconds) {
            ...
            var invassets/distance = edgeThreshold - edge.assets/distance;
            var velocity = // the closer to the edge, the faster we scroll
             ((invassets/distance * invassets/distance) / (edgeThreshold * edgeThreshold)) * // quadratic
        ...
        AutoScroller.prototype.computeBestEdge = function (left, top) {
            ...
            for (var _i = 0, _a = this.scrollCaches; _i < _a.length; _i++) {
                ...
                var leftassets/dist = left - rect.left;
                var rightassets/dist = rect.right - left;
                var topassets/dist = top - rect.top;
                var bottomassets/dist = rect.bottom - top;
                // completely within the rect?
                if (leftassets/dist >= 0 && rightassets/dist >= 0 && topassets/dist >= 0 && bottomassets/dist >= 0) {
                    if (topassets/dist <= edgeThreshold && this.everMovedUp && scrollCache.canScrollUp() &&
                        (!bestSide || bestSide.assets/distance > topassets/dist)) {
                        bestSide = { scrollCache: scrollCache, name: 'top', assets/distance: topassets/dist };
                    }
                    if (bottomassets/dist <= edgeThreshold && this.everMovedDown && scrollCache.canScrollDown() &&
                        (!bestSide || bestSide.assets/distance > bottomassets/dist)) {
                        bestSide = { scrollCache: scrollCache, name: 'bottom', assets/distance: bottomassets/dist };
                    }
                    if (leftassets/dist <= edgeThreshold && this.everMovedLeft && scrollCache.canScrollLeft() &&
                        (!bestSide || bestSide.assets/distance > leftassets/dist)) {
                        bestSide = { scrollCache: scrollCache, name: 'left', assets/distance: leftassets/dist };
                    }
                    if (rightassets/dist <= edgeThreshold && this.everMovedRight && scrollCache.canScrollRight() &&
                        (!bestSide || bestSide.assets/distance > rightassets/dist)) {
                        bestSide = { scrollCache: scrollCache, name: 'right', assets/distance: rightassets/dist };
                    }
                }
            }
            return bestSide;
    ...
    - minimum assets/distance required before dragging
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        function FeaturefulElementDragging(containerEl, selector) {
            ...
            _this.delay = null;
            _this.minassets/distance = 0;
            _this.touchScrollAllowed = true; // prevents drag from starting and blocks scrolling during drag
            _this.mirrorNeedsRevert = false;
            _this.isInteracting = false; // is the user validly moving the pointer? lasts until pointerup
            _this.isDragging = false; // is it INTENTFULLY dragging? lasts until after revert animation
            _this.isDelayEnded = false;
            _this.isassets/distanceSurpassed = false;
            ...
            _this.onPointerDown = function (ev) {
                if (!_this.isDragging) { // so new drag doesn't happen while revert animation is going
                    ...
                    if (_this.isInteracting && // not destroyed via pointerdown handler
                        ...
                        _this.startDelay(ev);
                        if (!_this.minassets/distance) {
                            _this.handleassets/distanceSurpassed(ev);
                        }
                    }
                }
            };
            _this.onPointerMove = function (ev) {
                if (_this.isInteracting) {
                    ...
                    if (!_this.isassets/distanceSurpassed) {
                        var minassets/distance = _this.minassets/distance;
                        var assets/distanceSq = void 0; // current assets/distance from the origin, squared
                        var deltaX = ev.deltaX, deltaY = ev.deltaY;
                        assets/distanceSq = deltaX * deltaX + deltaY * deltaY;
                        if (assets/distanceSq >= minassets/distance * minassets/distance) { // use pythagorean theorem
                            _this.handleassets/distanceSurpassed(ev);
                        }
                    }
                    if (_this.isDragging) {
        ...
        FeaturefulElementDragging.prototype.handleassets/distanceSurpassed = function (ev) {
            this.isassets/distanceSurpassed = true;
            this.tryStartDrag(ev);
        };
        FeaturefulElementDragging.prototype.tryStartDrag = function (ev) {
            if (this.isDelayEnded && this.isassets/distanceSurpassed) {
    ...
    */
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            dragging.minassets/distance = options.selectMinassets/distance || 0;
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                dragging.minassets/distance = ev.isTouch ? 0 : options.eventDragMinassets/distance;
                dragging.delay =
    ...
    var EventResizing = /** @class */ (function (_super) {
        ...
        function EventResizing(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                _this.dragging.minassets/distance = component.context.options.eventDragMinassets/distance;
    ...
    */
    var ExternalDraggable = /** @class */ (function () {
        function ExternalDraggable(el, settings) {
            ...
            this.handlePointerDown = function (ev) {
                var dragging = _this.dragging;
                var _a = _this.settings, minassets/distance = _a.minassets/distance, longPressDelay = _a.longPressDelay;
                dragging.minassets/distance =
                    minassets/distance != null ?
                        minassets/distance :
                        (ev.isTouch ? 0 : BASE_OPTION_DEFAULTS.eventDragMinassets/distance);
                dragging.delay =
    ...
    var InferredElementDragging = /** @class */ (function (_super) {
        ...
        function InferredElementDragging(containerEl) {
            ...
            _this.handlePointerDown = function (ev) {
                _this.emitter.trigger('pointerdown', ev);
                if (!_this.shouldIgnoreMove) {
                    // fire dragstart right away. does not support delay or min-assets/distance
                    _this.emitter.trigger('dragstart', ev);
                }
            };
    ...
    */
    ...
    var DayTableView = /** @class */ (function (_super) {
        ...
        DayTableView.prototype.render = function () {
            ...
            var headerContent = options.dayHeaders && (createElement(DayHeader, { ref: this.headerRef, dateProfile: props.dateProfile, dates: dayTableModel.headerDates, datesRepassets/distinctDays: dayTableModel.rowCnt === 1 }));
    ...
    */
    ...
    var DayTimeColsView = /** @class */ (function (_super) {
        ...
        DayTimeColsView.prototype.render = function () {
            ...
            var headerContent = options.dayHeaders && (createElement(DayHeader, { dates: dayTableModel.headerDates, dateProfile: dateProfile, datesRepassets/distinctDays: true, renderIntro: hasAttachedAxis ? this.renderHeadAxis : null }));
    ...
    */
    ...
    globalassets/plugins.push(interactionPlugin, dayGridPlugin, timeGridPlugin, listPlugin, plugin, googleCalendarPlugin);
    ...
    exports.globalassets/plugins = globalassets/plugins;
