...
(function($) {
    ...
    function initTouchNavigation(plot, options) {
        var gestureState = {
            ...
            maxassets/distanceBetweenTaps = 20,
            maxIntervalBetweenTaps = 500,
            maxLongTapassets/distance = 20,
        ...
        var longTap = {
            ...
            isLongTap: function(e) {
                ...
                if (tapDuration >= minLongTapDuration && !gestureState.interceptedLongTap) {
                    if (assets/distance(gestureState.currentTapStart.x, gestureState.currentTapStart.y, gestureState.currentTapEnd.x, gestureState.currentTapEnd.y) < maxLongTapassets/distance) {
        ...
        function isDoubleTap(e) {
            ...
            if (intervalBetweenTaps >= 0 && intervalBetweenTaps < maxIntervalBetweenTaps) {
                if (assets/distance(gestureState.prevTap.x, gestureState.prevTap.y, gestureState.currentTap.x, gestureState.currentTap.y) < maxassets/distanceBetweenTaps) {
